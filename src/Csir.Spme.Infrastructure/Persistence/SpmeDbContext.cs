    ...
    ILeaveRequestRepository
{
    ...
    public DbSet<AppraisalTrainingRecord> AppraisalTrainingRecords => Set<AppraisalTrainingRecord>();
    public DbSet<AppraisalTarget> AppraisalTargets => Set<AppraisalTarget>();
    public DbSet<AppraisalTargetVersion> AppraisalTargetVersions => Set<AppraisalTargetVersion>();
    public DbSet<AppraisalKeyCompetency> AppraisalKeyCompetencies => Set<AppraisalKeyCompetency>();
    public DbSet<AppraisalMidyearTargetReview> AppraisalMidyearTargetReviews => Set<AppraisalMidyearTargetReview>();
    public DbSet<AppraisalMidyearCompetencyReview> AppraisalMidyearCompetencyReviews => Set<AppraisalMidyearCompetencyReview>();
    public DbSet<AppraisalYearEndResult> AppraisalYearEndResults => Set<AppraisalYearEndResult>();
    public DbSet<AppraisalHodSubmission> AppraisalHodSubmissions => Set<AppraisalHodSubmission>();
    public DbSet<AppraisalMidyearTargetRemark> AppraisalMidyearTargetRemarks => Set<AppraisalMidyearTargetRemark>();
    public DbSet<AppraisalMidyearCompetencyRemark> AppraisalMidyearCompetencyRemarks => Set<AppraisalMidyearCompetencyRemark>();
    public DbSet<AppraisalTargetAmendment> AppraisalTargetAmendments => Set<AppraisalTargetAmendment>();
    public DbSet<AppraisalTargetAssessmentRecord> AppraisalTargetAssessmentRecords => Set<AppraisalTargetAssessmentRecord>();
    public DbSet<AppraisalCompetencyRatingRecord> AppraisalCompetencyRatingRecords => Set<AppraisalCompetencyRatingRecord>();
    public DbSet<AppraisalSignatureRecord> AppraisalSignatureRecords => Set<AppraisalSignatureRecord>();
    public DbSet<AppraisalDirectorDecision> AppraisalDirectorDecisions => Set<AppraisalDirectorDecision>();
    public DbSet<AppraisalReminderRecord> AppraisalReminderRecords => Set<AppraisalReminderRecord>();
